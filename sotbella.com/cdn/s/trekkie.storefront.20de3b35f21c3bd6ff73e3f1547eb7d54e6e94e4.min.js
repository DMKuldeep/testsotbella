! function() {
    var e = {
            ...
            1148: function(e, t, n) {
                ...
                function p(e, t) {
                    return "object" == typeof e && e.headlessStorefront && !e.storefrontAccessToken ? (console.warn("Headless consent has been updated. Please read shopify.dev/docs/api/customer-privacy to integrate."), a.setStorefrontApiTrackingConsent(e, t || (() => {}))) : o.setTrackingConsent(e, t)
                }
                ...
                }, t.urlConsentParam = function() {
                    const e = d();
                    return `__cmpecs=${Object.entries(e).map((([e,t])=>[a.transformDisplayNameToKey(e),a.transformDisplaySchemaToConsent(t)])).filter((e=>e[1]!=i.ConsentValues.NO_VALUE)).map((e=>e.join(""))).join("")}`
                }
            },
            5732: function(e, t, n) {
                "use strict";
                ...
                function a() {
                    ...
                    if (void 0 !== e && ! function(e) {
                            var t;
                            return e.v !== o.CookieVersion || (null == e || null === (t = e.con) || void 0 === t || !t.CMP)
                        }(e)) return e
                }
                ...
                t.CONSENT_COOKIE_NAME = i, t.getCCPAConsentValue = function() {
                    return c()[o.ConsentKeys.SALE_OF_DATA]
                }, t.getCMPConsentValues = c, t.getCustomValue = function(e) {
                    const t = s();
                    if (u(t) || !t.cus) return;
                    ...
                    const e = s();
                    if (!u(e) && e.cus) return Object.entries(e.cus).map((([e, t]) => ({
                    ...
                    const e = s();
                    return u(e) ? "" : e.region || ""
                }, t.getSignal = d, t.readCookieAndTransform = s, t.setStorefrontApiTrackingConsent = function(e, t) {
                    ...
                    return r.writeCookie(i, e.rootDomain, 31536e6, c), t(null), new Promise(((e, t) => {}))
                ...
                }, t.transformDisplayNameToKey = function(e) {
                    switch (e) {
                        case o.ConsentDisplayKeys.ANALYTICS:
                            return o.ConsentKeys.ANALYTICS;
                        case o.ConsentDisplayKeys.MARKETING:
                            return o.ConsentKeys.MARKETING;
                        case o.ConsentDisplayKeys.PREFERENCES:
                            return o.ConsentKeys.PREFERENCES;
                        case o.ConsentDisplayKeys.SALE_OF_DATA:
                            return o.ConsentKeys.SALE_OF_DATA
                    }
                }, t.transformDisplaySchemaToConsent = function(e) {
                    switch (e) {
                        case o.DisplayConsentValues.ACCEPTED:
                            return o.ConsentValues.ACCEPTED;
                        case o.DisplayConsentValues.DECLINED:
                            return o.ConsentValues.DECLINED;
                        default:
            ...
            5730: function(e, t, n) {
                ...
                function s() {
                    if (r.validCookieDoesNotExist()) return o.DisplayConsentValues.NO_VALUE;
                ...
                function c(e) {
                    return e ? u() ? window.location.pathname + window.location.search : "/" : null
                }
                ...
                function d() {
                    return i.marketingProcessingAllowed() && i.analyticsProcessingAllowed()
                }

                function p() {
                    return i.saleOfDataRegion() ? "string" == typeof navigator.globalPrivacyControl ? "1" !== navigator.globalPrivacyControl : "boolean" == typeof navigator.globalPrivacyControl ? !navigator.globalPrivacyControl : null : null
                }
                ...
                t.saleOfDataRegion = i.saleOfDataRegion, t.GPCSignal = p, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                ...
                }, t.getTrackingConsent = s, t.getTrackingConsentMetafield = function(e) {
                    return r.getCustomValue(e)
                }, t.getTrackingConsentMetafields = function() {
                    return r.getCustomValues()
                }, t.hasConsentForGDPR = d, t.haveAnalyticsConsent = function() {
                    return i.analyticsProcessingAllowed()
                }, t.haveMarketingConsent = function() {
                    return i.marketingProcessingAllowed()
                }, t.havePreferencesConsent = function() {
                    return i.preferencesProcessingAllowed()
                }, t.haveSaleOfDataConsent = function() {
                    return i.saleOfDataAllowed()
                }, t.isBuyerOnFirstPageOfVisit = u, t.isRegulationEnforced = function() {
                    ...
                    const r = function(e) {
                            return e ? u() ? document.referrer : "" : null
                        }(n.analytics),
                        i = c(n.analytics);
                    return a.storefrontApiUpdateTrackingConsent({
                        granular_consent: n,
                    ...
                    return console.warn("shouldShowCCPABanner is deprecated and will be removed."), i.saleOfDataRegion() && l() === o.DisplayConsentValues.NO_INTERACTION
                }, t.shouldShowGDPRBanner = function() {
                    return i.shouldShowBanner() && s() === o.DisplayConsentValues.NO_INTERACTION
                }, t.userCanBeTracked = function() {
                    return !!r.validCookieDoesNotExist() || d()
                }, t.userDataCanBeSold = function() {
                    return console.warn("userDataCanBeSold is deprecated and will be replaced with saleOfDataAllowed."), i.saleOfDataAllowed()
                }
            },
            809: function(e, t) {
                "use strict";
                ...
                function n(e, t = !1) {
                    ...
                    for (let t = 0; t < r.length; t++) {
                        const [n, o] = r[t].split("=");
                        if (e === decodeURIComponent(n)) return JSON.parse(decodeURIComponent(o))
                    }
                    if (t && "_cmp_a" === e && !window.localStorage.getItem("cmp_a_fetched")) return console.debug("_cmp_a missing"), o(), window.localStorage.setItem("cmp_a_fetched", "true"), n(e, !1)
                }
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.makeSynchronousRequest = o, t.readCookie = function(e) {
                    return n(e)
                }, t.writeCookie = function(e, t, n, o) {
                    if (!r(o)) throw new TypeError("Cookie value is not correctly URI encoded.");
                    if (!r(e)) throw new TypeError("Cookie name is not correctly URI encoded.");
                    let i = `${e}=${o}`;
            ...
            8680: function(e, t, n) {
                ...
                function d(e) {
                    ...
                    return {
                        query: `query { consentManagement { cookies(${s.objectToGraphQL(n)}) { answersCookie trackingConsentCookie cookieDomain landingPageCookie origReferrerCookie } } }`,
                        variables: {}
                    }
                }
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    const n = e.granular_consent,
                        s = n.storefrontAccessToken || function() {
                        ...
                        l = n.isExtensionToken ? "Shopify-Storefront-Extension-Token" : "x-shopify-storefront-access-token",
                        f = {
                            headers: {
                                "content-type": "application/json",
                                [l]: s
                            },
                            body: JSON.stringify(d(e)),
                            method: "POST"
                        };
                    return fetch(`https://${p}/api/unstable/graphql.json`, f).then((e => {
                        ...
                        const d = 31536e6,
                            p = 12096e5,
                            l = s.data.consentManagement.cookies.cookieDomain,
                            f = n.checkoutRootDomain || l || window.location.hostname,
                            _ = n.storefrontRootDomain || l || window.location.hostname,
                            h = s.data.consentManagement.cookies.trackingConsentCookie,
                            v = s.data.consentManagement.cookies.answersCookie,
                            g = s.data.consentManagement.cookies.landingPageCookie,
                            y = s.data.consentManagement.cookies.origReferrerCookie;
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, f, d, h), r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, f, d, v), g && y && (r.writeCookie(c, f, p, g), r.writeCookie(u, f, p, y)), _ !== f && (r.writeCookie(i.CONSENT_COOKIE_NAME, _, d, h), r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, _, d, v), g && y && (r.writeCookie(c, _, p, g), r.writeCookie(u, _, p, y))), o.dispatchEvents(e), void 0 !== t && t(null, s), s
                    })).catch((e => {
            ...
            7249: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    ACCEPTED: "1",
                    DECLINED: "0"
                }, t.CookieVersion = "2.1", t.DataProcessingPurpose = {
                    PREFERENCES: "p",
                    ANALYTICS: "a",
                    MARKETING: "m",
                    SALE_OF_DATA: "t"
                    ...
                    l = function(e) {
                        ...
                        return r(t, e), t.prototype.initialize = function() {
                            ...
                            "localhost" === s.hostname() && (n.domain = "none"), n.enhancedEcommerce && this.enhancedEcommerce(), p.shouldSetGoogleConsentMode() && window.gtag("consent", "default", p.generateGoogleConsentModeObject()), window.ga("create", n.trackingId, {
                                ...
                                allowLinker: !0
                            }), (window.gaDevIds = window.gaDevIds || []).push("dNzQ1OW"), n.doubleClick && window.ga("require", "displayfeatures"), n.enhancedLinkAttribution && window.ga("require", "linkid"), n.anonymizeIp && window.ga("set", "anonymizeIp", !0), e.prototype.initialize.call(this)
                        }, t.prototype.name = function() {
                ...
                var i = n(9414),
                    ...
                    p = function(e) {
                        ...
                        return r(t, e), t.prototype.initialize = function() {
                            ...
                            var e = this.options;
                            window.gtag("set", "developer_id." + t.developerId, !0), window.gtag("js", new Date), a.script({
            ...
            3988: function(e, t, n) {
                ...
                var g = function(e) {
                    function n(t, o, r) {
                        ...
                        return a.pageID = _.default.microSessionId, a
                    }
                    return r(n, e), n.prototype.name = function() {
                        ...
                        n.orderId && (o.order_id = n.orderId.toString()), this.produceToMonorail({
                        ...
                        var t = e.eventName,
                            ...
                            r = e.eventSchemaId,
                            i = e.source,
                            a = this.isCustomStorefront(t),
                            s = a ? p.customStorefrontAnalyticsSchemaId : p.storefrontAnalyticsSchemaId,
                            c = {
                                schemaId: r || s,
                                payload: this.eventWithMetadata(t, a ? this.payloadWithCustomStorefrontMetadata(o) : o, n, i)
                            };
                        d.produce([c])
                        ...
                        return i(i({
                            ...
                            asset_version_id: "20de3b35f21c3bd6ff73e3f1547eb7d54e6e94e4",
                            shop_analytics_token: this.getShopAnalyticsToken()
                        }, _.default.isMerchantRequest && {
                    ...
                    d = function(e) {
                        ...
                        return r(t, e), t.prototype.initialize = function() {
                            ...
                            t.load = function(e) {
                                ...
                                o.type = "text/javascript", o.async = !0, o.src = n + "?sdkid=" + e + "&lib=ttq&type=trekkie";
                    ...
                    if (void 0 === o)
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (y(e, a, 0, t), g(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "20de3b35f21c3bd6ff73e3f1547eb7d54e6e94e4",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                        ...
                        function(e) {
                            if (0 !== e.length) {
                                var t = {
                                    ...
                                    n = {};
                                n.metadata = t, n.events = e, i(o, JSON.stringify(n))
                            }
                        }(e)
                    ...
                    y = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "20de3b35f21c3bd6ff73e3f1547eb7d54e6e94e4",
                            ...
                            try {
                                ...
                                } else i = "checkout_completed" === s && n ? n : (null === (r = window.Shopify) || void 0 === r ? void 0 : r.evids) && s ? window.Shopify.evids(s, {
                                    analyticsFramework: "trekkie"
                                }) : d.buildToken()
                            } catch (e) {
                                i = d.buildToken()
                            ...
                            h.default.refreshVisitorTokens(), this.integrations.forEach((function(t) {
            ...
            3552: function(e, t, n) {
                ...
                const o = "sh",
                    ...
                    g = "checkout_shipping_step_started",
                ...
                function I() {
                    ...
                    e.Shopify = e.Shopify || {}, e.Shopify.evids || (A = {
                        ...
                        if (!A[e] || (null == t ? void 0 : t.analyticsFramework) !== T && (null == t ? void 0 : t.analyticsFramework) !== C) return S(r);
        ...
        function() {
            ...
            try {
                ...
                if (h) {
                    ...
                    var v = window[r],
                        g = window.trekkie = new e.Tricorder(i, h, (function() {
                            window[r] = g, window._visit = {
                                tag: function() {},
