! function() {
    ...
    var e, t = function() {
        ...
        v = function(e) {
            "hidden" === document.visibilityState && g > -1 && (g = "visibilitychange" === e.type ? e.timeStamp : 0, S())
        },
        y = function() {
        ...
        E = function(e, t) {
            t = t || {}, _((function() {
                var n, r = T(),
                    o = u("FCP"),
                    i = d("paint", (function(e) {
                        e.forEach((function(e) {
                            "first-contentful-paint" === e.name && (i.disconnect(), e.startTime < r.firstHiddenTime && (o.value = Math.max(e.startTime - c(), 0), o.entries.push(e), n(!0)))
                        }))
                    }));
                i && (n = f(e, o, w, t.reportAllChanges), s((function(r) {
                    o = u("FCP"), n = f(e, o, w, t.reportAllChanges), l((function() {
        ...
        M = function(e) {
            e.forEach((function(e) {
                e.interactionId && (x = Math.min(x, e.interactionId), I = Math.max(I, e.interactionId), b = I ? (I - x) / 7 + 1 : 0)
            }))
        },
        L = function() {
        ...
        j = function(e, n) {
            ...
            D((function() {
                ...
                if (i) {
                    ...
                    r.value = Math.max(a - c(), 0), r.entries = [i], o(!0), s((function() {
                        r = u("TTFB", 0), (o = f(e, r, F, n.reportAllChanges))(!0)
                    }))
                }
            }))
        };
    ...
    function J({
        ...
        try {
            const t = $[e || ""];
            if (!t) return void console.debug("📡 Monorail: ", JSON.stringify(o, null, 2));
            if ("function" != typeof window.navigator.sendBeacon || "function" != typeof window.Blob || function() {
                ...
                e.open("POST", t), e.setRequestHeader("Content-type", "text/plain"), e.send(JSON.stringify(o))
            } else {
    ...
    function K(e) {
        const t = ["domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "firstPaint", "visuallyReady", "initiatorType", "redirectCount"].reduce(((t, n) => {
            var r;
            return e[n] && (t[(r = n, r.replace(/[A-Z]/g, (e => `_${e.toLowerCase()}`)))] = e[n] || null), t
        }), {});
        return {
        ...
        e.OnInteraction = "perf_kit_on_interaction/3.0", e.OnUnload = "perf_kit_on_unload/3.1"
    }(U || (U = {}));
    const V = "/shopifycloud/consent-tracking-api/v0.1/consent-tracking-api.js";
    async function X() {
        const e = `https://${window?.Shopify?.cdnHost||"cdn.shopify.com"}`;
        try {
            return function(e) {
                return null !== document.querySelector(`script[src="${e}${V}"]`)
            }(e) ? Promise.resolve(!0) : await
            function(e) {
                const t = new Promise(((t, n) => {
                    const r = document.createElement("script");
                    r.type = "text/javascript", r.src = `${e}${V}`, r.onload = () => {
                        t(!0)
                    }, r.onerror = () => {
                        n(new Error("Could not load consent script"))
    ...
    const Z = "xxxx-4xxx-xxxx-xxxxxxxxxxxx";
    ...
    function G() {
        ...
        return `${function(){let e=0,t=0;e=(new Date).getTime()>>>0;try{t=performance.now()>>>0}catch(e){t=0}return Math.abs(e+t).toString(16).toLowerCase().padStart(8,"0")}()}-${e}`
    }
    let Q = !0,
        W = !1,
        Y = null,
    ...
    class te {
        ...
        constructor(e) {
            const t = /_shopify_s=([^;]*)/.exec(document.cookie),
                ...
                o = r ? r[1] : void 0;
            this.config = e, this.info = {
                perfKitInit: Date.now(),
                perfKitVersion: "1.0.2",
                ...
                sessionToken: n,
                uniqueToken: o
            }, performance.setResourceTimingBufferSize(1e3), this.performanceMetrics = function(e) {
            ...
            }(this.info.perfKitInit), async function() {
                const {
                    Shopify: e
                } = window;
                e && e.customerPrivacy || await X()
            }()
        }
    }
    const ne = new Set;
    ...
    function re() {
        if (null !== Y) {
            if (ae() && ne.size > 0) {
                let e = {};
                for (const t of ne) e = { ...e,
                    ...t
                };
                ne.clear(), Y.info.microSessionCount += 1;
                const t = function(e) {
                    if (!(100 * Math.random() > (e || H))) return performance.getEntriesByType("resource").map((e => {
                        const t = Object.entries(e.toJSON()).map((([e, t]) => "number" == typeof t ? [e, Math.round(t)] : [e, t]));
                        return JSON.stringify(Object.fromEntries(t))
                    }))
                }(Y.config.resourceTimingSamplingRate);
                J({
                    monorailRegion: Y.config.monorailRegion,
                    schema: U.OnUnload,
                    rawData: { ...Y.info,
                        ...Y.config.storefrontData,
                        ...Y.performanceMetrics,
                        ...e,
                        resourceTiming: t,
                        paintTimingHidden: ee
                    }
                })
            }
    ...
    oe = function(e) {
        ...
        function(e, t) {
            t = t || {}, E(p((function() {
                var n, r = u("CLS", 0),
                    ...
                    c = d("layout-shift", a);
                c && (n = f(e, r, C, t.reportAllChanges), m((function() {
                    a(c.takeRecords()), n(!0)
                })), s((function() {
                    o = 0, r = u("CLS", 0), n = f(e, r, C, t.reportAllChanges), l((function() {
                        return n()
                    }))
                })), setTimeout(n, 0))
            })))
            ...
            ! function(e, t) {
                t = t || {}, _((function() {
                    var n, r = T(),
                        ...
                        i = function(e) {
                            var t = e[e.length - 1];
                            t && t.startTime < r.firstHiddenTime && (o.value = Math.max(t.startTime - c(), 0), o.entries = [t], n())
                        },
                        a = d("largest-contentful-paint", i);
                    if (a) {
                        n = f(e, o, z, t.reportAllChanges);
                        var g = p((function() {
                            A[o.id] || (i(a.takeRecords()), a.disconnect(), A[o.id] = !0, n(!0))
                        }));
                        ["keydown", "click"].forEach((function(e) {
                            ...
                            o = u("LCP"), n = f(e, o, z, t.reportAllChanges), l((function() {
                                o.value = performance.now() - r.timeStamp, A[o.id] = !0, n(!0)
                            }))
                        }))
                    }
                }))
                ...
                ! function(e) {
                    if (e.entries.length) {
                        ...
                        if (n) {
                            ...
                            return i.url && (f.url = i.url), a && (f.lcpResourceEntry = a), void(e.attribution = f)
                        }
                    }
                    e.attribution = {
                        timeToFirstByte: 0,
        ...
        function(e, t) {
            ! function(e, t) {
                t = t || {}, _((function() {
                    ...
                    var r, o = u("INP"),
                        i = function(e) {
                            e.forEach((function(e) {
                                e.interactionId && q(e), "first-input" === e.entryType && !N.some((function(t) {
                                    return t.entries.some((function(t) {
                                        return e.duration === t.duration && e.startTime === t.startTime
                                    }))
                                })) && q(e)
                            }));
                            var t, n = (t = Math.min(N.length - 1, Math.floor(R() / 50)), N[t]);
                            n && n.latency !== o.value && (o.value = n.latency, o.entries = n.entries, r())
                        },
                        a = d("event", i, {
                            durationThreshold: null !== (n = t.durationThreshold) && void 0 !== n ? n : 40
                        });
                    r = f(e, o, P, t.reportAllChanges), a && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && a.observe({
                        type: "first-input",
                        buffered: !0
                    }), m((function() {
                        i(a.takeRecords()), o.value < 0 && R() > 0 && (o.value = 0, o.entries = []), r(!0)
                    })), s((function() {
                        N = [], B = L(), o = u("INP"), r = f(e, o, P, t.reportAllChanges)
                    })))
                }))
            }((function(t) {
                ! function(e) {
            ...
            null !== Y ? ae() && (Y.info.microSessionCount += 1, J({
                monorailRegion: Y.config.monorailRegion,
                schema: U.OnInteraction,
                rawData: { ...Y.info,
                    ...Y.config.storefrontData,
                    ...Y.performanceMetrics,
        ...
        function(e, t) {
            ...
            ee = "hidden" === document.visibilityState
        })), addEventListener("visibilitychange", (() => {
            "hidden" === document.visibilityState && re()
        })),
        function() {
            const {
                dataset: e
            ...
            try {
                t = function(e) {
                    if (!e.application) throw new Error("Application is missing");
                    if (!["storefront-renderer", "hydrogen"].includes(e.application.toLowerCase())) throw new Error("Invalid application type");
                    if (!e.shopId) throw new Error("shopId is missing");
                    if (!e.themeInstanceId && !e.storefrontId) throw new Error("Either `themeInstanceId` or `storefrontId` must be defined");
                    for (const t of ["shopId", "humannessScore", "themeInstanceId", "storefrontId"])
                        if (e[t] && isNaN(Number(e[t]))) throw new Error(`Invalid ${t}`);
                    if (e.monorailRegion && !["shop_domain", "global", "staging", "canada"].includes(e.monorailRegion.toLowerCase())) throw new Error("Invalid monorail region");
                    if (e.resourceTimingSamplingRate && (isNaN(Number(e.resourceTimingSamplingRate)) || Number(e.resourceTimingSamplingRate) < H || Number(e.resourceTimingSamplingRate) > 100)) throw new Error("Invalid resource timing sampling rate");
                    return {
                        storefrontData: {
                ...
                }(e), Y = new te(t), t.spaMode && (window.PerfKit = {
                    navigate: () => {
                        Q ? Q = !1 : W || (re(), Y = new te(t), W = !0)
                    },
                    setPageType: e => {
