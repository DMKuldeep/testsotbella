(() => {
    ...
    r.amdO = {}, r.n = e => {
        ...
        const b = "production",
            m = "0.0.475",
            h = "3c762e5aw5b983e43pc2dc4883m545d5a27",
            w = "s3c762e5aw5b983e43pc2dc4883m545d5a27m.js";
        var v = r(3482),
            g = r.n(v);
        ...
        function U(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new D(`URL must be secure (HTTPS): ${t.href}`);
            if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
            const r = M.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${M.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new _(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        ...
        function W(e, t, r) {
            try {
                ...
                if (Array.isArray(r)) {
                    const [n, o] = r;
                    "function" == typeof i && (i = e[t]), q(i, function(e) {
                        const t = new Set;
                        let r = e;
        ...
        const J = async e => {
            ...
            Z = !0, a(i);
            try {
                X && (i.browser.sendBeacon = E), X || (C(e), self.document.title = t)
            } catch (s) {
                throw O(s, {
                    pixelId: r.id,
                    pixelType: r.type,
        ...
        (() => {
            try {
                ...
                }(t.addEventListener)), q(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), j(self, "String", {
                    writable: !1,
                    configurable: !1
                }), j(self, "Request", {
                    writable: !1,
...
globalThis.shopify = self.webPixelsManager.createShopifyExtend('285212974', 'app');
importScripts('/wpm/strict/app/web-pixel-285212974@2c024cd91ca56b8917c3e5d26c96fac3.js');